...
public class FuncionarioServiceTest {
	...
	public void testBuscarFuncionarioPorEmail() {
		...
		Optional<Funcionario> funcionario = this.funcionarioService.bucarPorEmail("email@email.com");
	...
	public void testBuscarFuncionarioPorCpf() {
		...
		Optional<Funcionario> funcionario = this.funcionarioService.buscarPorCpf("36576859015");
